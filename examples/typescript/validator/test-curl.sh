...
# Test script for Essay Word Count API
...
# Test 5: Error case - empty essay
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Test 5: Error Handling - Empty Essay"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
curl -X POST "$BASE_URL/word-count" \
  -H "Content-Type: application/json" \
  -d '{"essay": ""}' \
...
# Test 6: Single word essay
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Test 6: Single Word Essay"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
curl -X POST "$BASE_URL/word-count" \
  -H "Content-Type: application/json" \
  -d '{"essay": "Hello"}' \
