...
export class HashgraphService {
  ...
  public async createAgentCard() {
    const agentCard: AgentCard = {
      name: "Verus Protocol Sponsor",
      description: "A sponsor that sponsors jobs on the Verus Network.",
      ...
      skills: [
        {
          id: "job-sponsorship",
          name: "Job Sponsorship",
          description: "Sponsor a job on the Verus Network",
          tags: ["job-sponsorship"],
        },
      ],
